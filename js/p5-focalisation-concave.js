...
function setup() {
    ...
    pos = createVector(191, 30);
    pos2 = createVector(191, 170);
    pos3 = createVector(196, 50);
    pos4 = createVector(196, 150);
    pos5 = createVector(200, 70);
    pos6 = createVector(200, 130);
...
function draw() {
    ...
    noFill();
    stroke('lightblue');
    arc(objectif.x, objectif.y, 50, 200, -HALF_PI + 0.1, HALF_PI - 0.1);
    arc(objectif.x+1, objectif.y, 50, 200, -HALF_PI + 0.1, HALF_PI - 0.1);
        ...
        if(position.x>191) {
            ...
            if(!isObjectif) {
                ...
                <div class='alert alert-info alert-dismissible' role='alert'>\
                    <div>Les rayons lumineux se refl&egrave;tent pour converger sur le point focal.</div>\
